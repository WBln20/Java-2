		...
		do {
			...
			if (waehrung.equals("E") || waehrung.equals("e")) {
				...
				do {
					try {
						...
						// Ausgabe der umgerechneten Währung
			...
			// Abfrage, ob Dollar eingegeben wurde
				...
				do {
					...
					System.out.println("Sie haben eine unbekannte Waehrung eingegeben. Bitte geben Sie nochmal entweder E für Euro oder U für US-Dollar ein! ");
				}
